const 山梨県 = {
 ...
 if(typeof cityObjs === 'undefined'){cityObjs = {};} cityObjs['山梨県'] = 山梨県;
{
  // Get N/S/E/W ends
  ...
  const ends = getEnds(山梨県['polygons']);
  ...
  const normalizedPolygons = 山梨県['polygons'].map( (polygon) => {
  ...
  山梨県['normalizedPolygons'] = normalizedPolygons;
}
